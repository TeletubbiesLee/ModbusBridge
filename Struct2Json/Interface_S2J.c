...
cJSON *ConfigFile_StructToJson(void* struct_obj)
{
	...
	s2j_json_set_basic_element(json_obj, struct_Config, int, functionCode);	//参数
	s2j_json_set_basic_element(json_obj, struct_Config, int, dataType);	//参数
	s2j_json_set_basic_element(json_obj, struct_Config, int, serialNumber);	//参数
	s2j_json_set_basic_element(json_obj, struct_Config, int, startAddress);	//参数
...
ConfigFile *ConfigFile_JsonToStruct(cJSON* json_obj)
{
	...
	s2j_struct_get_basic_element(struct_Config, json_obj, int, startAddress);	//参数
